            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className="px-4 py-2.5 rounded-2xl bg-ai-gradient hover:opacity-95 text-white font-extrabold text-xs shadow-md shadow-teal-900/20 transition-all flex items-center space-x-1.5 cursor-pointer"
                >
                  <Sparkles className="w-4 h-4 text-[#F59E0B]" />
                  <span>Intermediate Premium ($10/mo)</span>
                </button>

                <button
                  onClick={() => {
                    setSelectedPlanToUpgrade('advanced_premium');
                    setCheckoutModalOpen(true);
                  }}
                  className="px-4 py-2.5 rounded-2xl bg-[#042F2C] hover:bg-[#084c47] text-white font-extrabold text-xs shadow-md border border-[#14B8A6]/40 transition-all flex items-center space-x-1.5 cursor-pointer"
                >
